...
const NeonText = ({ text, isInView = true, className = "", firstLoad = false }) => {
                ...
                intervalId = setInterval(() => {
                    ...
                    wordRefs.current.forEach((ref, i) => {
                        ...
                        if (step > wordDelay) {
                            ...
                            const progress = Math.min(1, (step - wordDelay) / 1000); // 500ms animation duration

                            if (progress < 1) {
                                // During animation, randomize opacity for pixel effect
                                const randomOpacity = Math.random() * 0.5 + progress * 0.75;
