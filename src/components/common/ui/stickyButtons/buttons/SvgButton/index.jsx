...
export default function SVGButton({ src, altText, onClick }) {
    ...
    return (
        <Magnetic sensitivity='0.05'>
            <motion.div transformTemplate={template} data-cursor-target onClick={onClick} ref={buttonRef} style={{ scaleX: scale.x, scaleY: scale.y }} className='Svg__button_container'>
