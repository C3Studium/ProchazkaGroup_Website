...
export default function RotatingButton({ href, text }) {
    ...
    const [currentRadius, setCurrentRadius] = useState(70); // Default radius
    ...
    // Add effect to update radius based on viewport
    // useEffect(() => {
    //     const updateRadius = () => {
    ...
    //             setCurrentRadius(80); // Set radius to 80 for the specified viewport
    //         } else if (width >= 960 && width < 1260) {
    //             setCurrentRadius(75); // Set radius to 70 for the specified viewport
    //         } else if (width <= 960) {
    //             setCurrentRadius(70); // Set radius to 70 for smaller viewports{
    //         } else {
    //             setCurrentRadius(90); // Default radius for other viewports
    //         }
    //     };
    ...
    return (
        <Magnetic sensitivity='0.1'>
            <motion.div transformTemplate={template} data-cursor-target ref={buttonRef} style={{ scaleX: scale.x, scaleY: scale.y }} className='Rotating__button_container'>
