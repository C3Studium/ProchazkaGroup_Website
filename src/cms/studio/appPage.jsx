...
// Studio jako stránka App Routeru.
//
// Liší se od varianty pro Pages Router dvěma věcmi a nic víc mezi nimi není:
// direktivou `use client` a adaptérem navigace. Studio je stavová aplikace za
// přihlášením, takže klientská je tak jako tak — v Pages Routeru to říká
// `dynamic({ ssr: false })`, tady direktiva.
//
// Titulek a `noindex` sem nepatří: v App Routeru je nese `metadata` ze
// serverové stránky a soubor s direktivou `use client` je exportovat nesmí.
// Proto je Studio klientská komponenta a stránka kolem ní zůstává serverová —
// to je rozdělení, které App Router čeká.
//
// Zbytek — líný port, načítací obrazovka, obal Studia — je společný a bydlí
// v ./page.jsx, odkud je tenhle soubor převzatý. Když se bude měnit, musí se
// změnit obojí; proto je ta odlišnost úmyslně tak malá.

import dynamic from "next/dynamic"
import { useMemo } from "react"
import { StudioShell } from "../index.js"
import * as core from "../core/index.js"
import { createClaritySource } from "./stats/clarity.js"
import { registerStatsSource } from "./stats/statsSource.js"
import { useAppNavigation } from "../runtime/appNavigation.js"
 ...
 */
export const StudioClient = ({ title = "Studio", booting = title }) => {
