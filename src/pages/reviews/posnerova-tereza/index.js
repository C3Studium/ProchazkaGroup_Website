...
export default function PersonFeebackPage2() {
    ...
    const [personData, setPersonData] = useState({
        ...
        number: '04',
        databaseName: 'Tereza Posnerová'
    })
    const srcbg = "/assets/backgrounds/secondOffice.webp"
    const srcp = "/assets/portraits/business/12.webp"
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const data = await fetchClovek("Tereza Posnerová")
    ...
    return (
        <>
            <Head>
                ...
                <meta property="profile:last_name" content="Posnerová" />
