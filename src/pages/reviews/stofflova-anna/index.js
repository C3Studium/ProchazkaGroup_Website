...
export default function PersonFeebackPage2() {
    ...
    const [personData, setPersonData] = useState({
        ...
        number: '10',
        databaseName: 'Anna Štofflová'
    })
    const srcbg = "/assets/backgrounds/mainOffice.webp"
    const srcp = "/assets/portraits/business/2.webp"
    const icons = [
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const data = await fetchClovek("Anna Štofflová")
    ...
    return (
        <>
            <Head>
                ...
                <meta property="profile:last_name" content="Štofflová" />
